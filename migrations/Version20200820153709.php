 ...
 */
final class Version20200820153709 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parking_space ADD CONSTRAINT FK_E00675CC593F72B7 FOREIGN KEY (parking_spaces_id) REFERENCES parking (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
